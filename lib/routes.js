...
//------------------------------------------------------------------------------------
	...
	// PRODUCTS - HIGHLIGHT-----------------------------------------------------------
		Router.route('/products_highlight_instructions', function () {
			this.render('products_highlight_instructions');
			this.layout('layout_products');
		});

	// PRODUCTS - PDF-----------------------------------------------------------------
		Router.route('/products_pdf_instructions', function () {
			this.render('products_pdf_instructions');
			this.layout('layout_products');
		});
...
//------------------------------------------------------------------------------------
	...
	// ACCOUNTS - LOGOUT---------------------------------------------------------------
		...
		Accounts.onLogin(function() {
			sAlert.success('Login complete! Kia Ora!');
		});
